...
const char text_type[]              = "type";
const char text_phone[]             = "phone";
const char text_ltype[]             = "ltype";
const char text_present[]           = "present";
...
const char text_updated[]           = "updated";
